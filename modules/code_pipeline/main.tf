resource "aws_s3_bucket" "source" {
  bucket        = "alexkoin-experiment-source"
  acl           = "private"
  force_destroy = true
}
...
resource "aws_codebuild_project" "alexkoin_build" {
  name          = "alexkoin-codebuild"
  build_timeout = "10"
...
resource "aws_codepipeline" "pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ProjectName = "alexkoin-codebuild"
      }
    }
  }
